...
public class UIScript : MonoBehaviour
{
    ...
    public GameObject OpenedCalendarObject;
    ...
    public void OpenedCalendar()
    {
        OpenedCalendarObject.transform.localScale = new Vector3(1, 1, 1);
    }

    public void ClosedCalendar()
    {
        OpenedCalendarObject.transform.localScale = new Vector3(0, 0, 0);
    }
}
